...
entity_name <- entity_name %>% str_replace_all("[:space:]","-")

file_path <- paste0("E:/reports/admin-uca/",entity_name,"-d.xlsx")
saveWorkbook(wb, file = file_path, overwrite = TRUE)


wb_summary <- createWorkbook()
addWorksheet(wb_summary, "summary of uca problems")

writeData(wb_summary,
            "summary of uca problems",
            uca_problems[["summary_of_problems"]],
            headerStyle = header_st)
  setColWidths(wb_summary, "summary of uca problems", cols = 1:ncol(uca_problems[["summary_of_problems"]]), widths = "auto")

file_path <- paste0("E:/reports/bad-uca/",entity_name,"-s.xlsx")
saveWorkbook(wb_summary, file = file_path, overwrite = TRUE)
}
```
