  ...
  rename("NUMBER" = "value") %>% 
    mutate( "DESCRIPTION" =
      case_when(
        ...
        #Old way was less readable. Preserved  just in case I switch back. 
...
invalid_object_code <- tibble(
  NUMBER = c(100,
             ...
             700,
             800),
  DESCRIPTION = c("Salaries (Header Only - Do Not Use.)",
...
invalid_revenue_code <- tibble(
  NUMBER = c(1000,
             ...
             4530,
             5000),
  DESCRIPTION = c("Revenue from Local Sources (Header Only – Do Not Use.)",
