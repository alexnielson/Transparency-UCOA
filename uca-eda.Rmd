  ...
  left_join(
    osa_lookup %>%
      ...
      select(
        ...
        lu_fund_level_primary = level_primary,
        lu_fund_level_secondary = level_secondary
      ),
    by = c("fund" = "number")
  ) %>%
  # join the functions
  left_join(
    osa_lookup %>%
      ...
      select(
        ...
        lu_funct_level_primary = level_primary,
        lu_funct_level_secondary = level_secondary,
        lu_funct_level_tertiary = level_tertiary
      ),
    by = c("funct" = "number")
  ) %>%
  # join the accounts
  left_join(
    osa_lookup %>%
      ...
      select(
        ...
        lu_account_level_primary = level_primary,
        lu_account_level_secondary = level_secondary,
        lu_account_level_tertiary = level_tertiary
      ),
    by = c("account" = "number")
  )
```
...
osa_bad_funct_code_primary<-osa_ucoa %>%
  filter(!funct_code_primary %in% (osa_lookup %>%
                        pluck("funct") %>%
                        select(code_primary) %>%
                        unlist()))

osa_bad_funct_code_secondary<-osa_ucoa %>%
  filter(!funct_code_secondary %in% (osa_lookup %>%
                        pluck("funct") %>%
                        select(code_secondary) %>%
                        unlist()))

osa_bad_funct_code_tertiary<-osa_ucoa %>%
  filter(!funct_code_tertiary %in% (osa_lookup %>%
                        pluck("funct") %>%
